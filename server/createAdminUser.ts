...
async function createAdminUserAndSync(email: string, password: string, role: string, id_empresa: number) {
  try {
...
const email = 'admin@pv.ai';
const password = '123456';
const role = 'super_admin';
const id_empresa = 1; // Assuming a default company ID for now

createAdminUserAndSync(email, password, role, id_empresa);
